...
import EditOrderShip from './components/EditOrderShip';
import EditOrder from './components/EditOrderShip';
// import { useDispatch } from 'react-redux';


function ShiperOrder() {
  ...
  const fetchData = useCallback( async () => {
    setLoading(true);
    try {
      const res = await shiperApi.getAllOrder();
  ...
  const columns = [
 ...
 
    {
      ...
      render: (i) => {
        ...
        return <EditOrderShip data={data} onEdit={() => {fetchData()}} />;
